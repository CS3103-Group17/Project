...
public class InstagramCrawler {
	...
	public ArrayList<IgData> getIgPosts(String searchTerm){
		
		ArrayList<IgData> list = new ArrayList<IgData>();
		...
		*/
		...
		while(it.hasNext()){
			...
			IgData temp = new IgData(idx, mediaFeedData.getUser().getUserName(), 
